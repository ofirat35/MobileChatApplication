...
namespace ChatApp.Core.Application.Features.Commands.Chats
{
    public class SendMessageCommandHandler(
      ...
      : BaseCommandHandler, IRequestHandler<SendMessageRequestCommand, ResponseModel<bool>>
    {
        public async Task<ResponseModel<bool>> Handle(SendMessageRequestCommand request, CancellationToken cancellationToken)
        {
    ...
    public class SendMessageRequestCommand : MessageCreateDto, IRequest<ResponseModel<bool>>
    {
    }
}
